                    ...
                    <div class="card">
                        <div class="card-body">                          
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-xl-4">
                                        <div class="card bg-c-orange order-card">
                                            <div class="card-block">
                                                ...
                                                $cant_docentes = Docente::count();                                                
                                                @endphp
                                                <h2 class="text-right"><i class="fa fa-blog f-left"></i><span>{{$cant_docentes}}</span></h2>
                                    ...
                                    <div class="col-md-4 col-xl-4">
                                        <div class="card bg-c-lilac order-card">
                                            <div class="card-block">
                                                <h5>Programas</h5>                                               
                                                @php
                                                 use App\Models\Programa;
                                                $cant_programas = programa::count();                                                
                                                @endphp
                                                <h2 class="text-right"><i class="fa fa-blog f-left"></i><span>{{$cant_programas}}</span></h2>
                                                <p class="m-b-0 text-right"><a href="/blogs" class="text-white">Ver más</a></p>
                                            </div>
                                        </div>
                                    </div>
